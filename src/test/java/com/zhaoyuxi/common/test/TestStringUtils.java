...
import com.zhaoyuxi.common.utils.StringUtils;

/**
 * @author 作者:赵玉玺
 * @version 创建时间：2019年9月8日 下午8:30:11 类功能说明
 */
public class TestStringUtils {
	...
	public void TestSubStr() {
		String string = StringUtils.getPlaceholderValue("http://news.cnstock.com/news,yw-201908-4413224.htm",
				"-[0-9]{7}\\.htm$");
	...
	public void testHtml() {
		...
		String html1=StringUtils.toHtml(str1);
...
class news {
	/*
	 * Integer id; title url score created
	 */
